...
""")
    print("=====================================================")
    print("""\033[1;96m]
Tool name:ALL IN ONE 
Creator:Lêkzï
Team:Greyhax0rs
Contact me on whatsapp:+2347064822519
""")
    print("'\x1b[1;92m====================================================")
    print(" [Choose The Tool You Would Like To Install Below]")
    print("""\n\033[1;92m[\033[1;94m
1. Install Calendar
2. Install Lekzleap     
...
""")
  ...
  git clone https://github.com/Lekzi/CALENDAR""")
      ...
      os.system("""cd
  git clone https://github.com/Lezi/Lekzleap""")
    elif t == "3":
      os.system("""cd
  ...
  git clone https://github.com/sundowndev/PhoneInfoga""")
      ...
      os.system("""cd
  git clone https:www.github.com/shubhushubhu99/Crasher.py""")
    elif t == "13":
      os.system("""cd
